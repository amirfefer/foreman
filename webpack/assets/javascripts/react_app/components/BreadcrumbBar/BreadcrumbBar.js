        ...
        <Breadcrumb title items={breadcrumbItems} isTitle={isTitle}>
          {isSwitchable && (
            <BreadcrumbSwitcher
              ...
              onNextPageClick={() => loadSwitcherResourcesByResource(resource, { page: Number(currentPage) + 1 }) }
              onPrevPageClick={() => loadSwitcherResourcesByResource(resource, { page: Number(currentPage) - 1 }) }
